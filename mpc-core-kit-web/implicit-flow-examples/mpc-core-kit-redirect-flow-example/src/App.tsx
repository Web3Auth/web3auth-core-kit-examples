...
function App() {
  ...
  return (
    <div className="container">
      ...
      <a href="https://github.com/Web3Auth/web3auth-core-kit-examples/tree/main/mpc-core-kit-web/implicit-flow-examples/mpc-core-kit-redirect-flow-example" target="_blank" rel="noopener noreferrer">
          Source code
        </a>
      </footer>
    </div>
