...
function App() {
  ...
  const getAccounts = async () => {
    ...
    const nearRPC = new NearRPC(coreKitInstance);
    const address = nearRPC.getAccount();
    uiConsole(address);
  };
  ...
  const getBalance = async () => {
    ...
    const nearRPC = new NearRPC(coreKitInstance);
    const balance = await nearRPC.getBalance();
    uiConsole(balance);
  };
  ...
  const signMessage = async () => {
    ...
    const nearRPC = new NearRPC(coreKitInstance);
    const signedMessage = await nearRPC.signMessage();
  ...
  const sendTransaction = async () => {
    ...
    const nearRPC = new NearRPC(coreKitInstance);
    const hash = await nearRPC.sendTransaction();
    uiConsole(`Hash: https://testnet.nearblocks.io/txns/${hash}`);
  };
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a
          href="https://github.com/Web3Auth/web3auth-core-kit-examples/tree/main/mpc-core-kit-web/mpc-core-kit-near"
          target="_blank"
