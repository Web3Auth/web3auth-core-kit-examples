...
import { GoogleAuthProvider, getAuth, signInWithPopup, signInWithEmailAndPassword, UserCredential } from "firebase/auth";
...
function App() {
  ...
  const enableMFA = async () => {
    ...
    uiConsole("MFA enabled, device factor stored in local store, deleted hashed cloud key, your firebase social account is used for recovery. ");
  };
