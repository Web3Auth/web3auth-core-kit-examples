...
function Recover() {
  const { coreKitStatus, criticalResetAccount, recoverViaAuthenticatorApp, recoverViaEmailPasswordless, recoverViaNumber, recoverViaPasskey } =
    useMPCCoreKit();
                    ...
                    return (
                      <Form formDetails={formDetailsSms}>
                        <button
                          ...
                          onClick={() => recoverViaNumber()}
                        >
                          Recover with SMS OTP
                        </button>
                      </Form>
                    );
                  case "authenticator":
                    return (
                      <button
                        className="w-full mt-10 mb-0 text-center justify-center items-center flex rounded-full px-6 py-3 text-white"
                        style={{ backgroundColor: "#0364ff" }}
                        onClick={() => recoverViaAuthenticatorApp()}
                      >
                        Recover with Authenticator App
                      </button>
                    );
                    ...
                    return (
                      <Form formDetails={formDetailsEmail}>
                        <button
                          className="w-full mt-10 mb-0 text-center justify-center items-center flex rounded-full px-6 py-3 text-white"
                          style={{ backgroundColor: "#0364ff" }}
                          onClick={() => recoverViaEmailPasswordless(email)}
                        >
                    ...
                    return (
                      <Form formDetails={formDetailsPasskey}>
                        <button
                          className="w-full mt-10 mb-0 text-center justify-center items-center flex rounded-full px-6 py-3 text-white"
                          style={{ backgroundColor: "#0364ff" }}
                          onClick={() => recoverViaPasskey(email)}
                        >
