...
function App() {
  ...
  return (
    <div className="container">
      ...
      <a href="https://github.com/Web3Auth/web3auth-core-kit-examples/tree/main/mpc-core-kit/mpc-core-kit-react-firebase-example" target="_blank" rel="noopener noreferrer">
          Source code
        </a>
      </footer>
    </div>
