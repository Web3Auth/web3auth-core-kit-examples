    ...
    <div className="container">
      <h1 className="title">
        <a target="_blank" href="https://web3auth.io/docs/guides/mpc" rel="noreferrer">
          Web3Auth Core Kit MPC Beta Popup
        </a> {" "}
        & ReactJS Ethereum Aggregate Verifier Example
      </h1>

      <div className="grid">{provider ? loggedInView : unloggedInView}</div>

      <footer className="footer">
        <a href="https://github.com/Web3Auth/web3auth-core-kit-examples/tree/main/tkey/mpc-core-kit/mpc-core-kit-react-popup-aggregate-example" target="_blank" rel="noopener noreferrer">
          Source code
        </a>
      </footer>
    </div>
