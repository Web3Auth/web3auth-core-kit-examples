      ...
      {isLoading ? (
        ...
        publicAddress && (
          <>
            ...
            <div className="bg-white dark:bg-zinc-800/30 shadow-lg rounded-lg p-8 max-w-md w-full mx-auto mt-10">
              <h2 className="text-l font-bold text-gray-800 dark:text-white">SignMessage & SendTransaction</h2>
              <button onClick={signMessage} className="bg-amber-600 text-white px-3 py-1 mt-4 mr-4 rounded-md">
                Sign Message
              </button>
              <button onClick={sendTransaction} className="bg-amber-600 text-white px-3 py-1 mt-4 rounded-md">
                Send Transaction
              </button>
            </div>
